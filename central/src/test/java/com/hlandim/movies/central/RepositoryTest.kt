package com.hlandim.movies.central
...
class RepositoryTest {
    ...
    private lateinit var repository: com.hlandim.movies.central.data.RepositoryImpl
    ...
    fun setup() {
        ...
        val dataSource = com.hlandim.movies.central.data.RemoteDataSource(service)

        repository = com.hlandim.movies.central.data.RepositoryImpl(dataSource)

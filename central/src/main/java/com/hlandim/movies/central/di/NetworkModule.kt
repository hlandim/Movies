...
import com.hlandim.movies.central.util.DateDeserialize
import com.hlandim.movies.central.util.RequestInterceptor
import com.hlandim.movies.central.util.Utils.hasInternetConnection
...
class NetworkModule {
    ...
    fun provideHttpClient(
        ...
        loggingInterceptor.level =
            if (BuildConfig.IS_LOG_ON) HttpLoggingInterceptor.Level.BODY else HttpLoggingInterceptor.Level.NONE
        return OkHttpClient
            .Builder()
